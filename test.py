...
img = window.create_boxImage((65,10),"C:\\users\\simon\\desktop\\lodestone_top.png",mode="background",width=32,height=16,resampling="nearest",exNonTexture=True)
window.draw()
window.sleep(0.5)
window.rotateShape(img,45)
window.fillBoundaryGap(img)
window.redrawC()